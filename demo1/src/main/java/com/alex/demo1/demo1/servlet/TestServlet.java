package com.alex.demo1.demo1.servlet;
...
public class TestServlet implements Servlet {
    ...
    public TestServlet(){
        System.out.println("TestServlet 对象初始化！！");
    }
    @Override
    ...
    public void service(ServletRequest servletRequest, ServletResponse servletResponse) throws ServletException, IOException {
        // 控制台打印，证明这个方法被调用了
        System.out.println("我是TestServlet，我执行了！");
...
// 3.通过servletConfig对象获取初始化参数
    ...
    @Override
    public void destroy() {
        System.out.println("TestServlet对象即将销毁，现在执行清理操作");
    }
}
